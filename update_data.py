...
MANUAL_FIX_DB = {
    "Pycnonotus sinensis": { # 白頭翁
        ...
        "desc": "白頭翁（學名：Pycnonotus sinensis），又名白頭鵯，是台灣非常常見的留鳥。特徵是頭頂後方的白色羽毛，叫聲嘹亮多變，常在城市公園與行道樹間活動。"
    },
    "Passer montanus": { # 麻雀
        ...
        "desc": "麻雀（學名：Passer montanus），是台灣最親近人類的鳥類之一。體型嬌小，頭頂為栗紅色，臉頰上有明顯的黑斑，喜歡成群在稻田或市區覓食。"
    },
    "Columba livia": { # 原鴿 (野鴿)
        ...
        "desc": "原鴿（學名：Columba livia），即常見的野鴿。羽色多變，通常為灰藍色帶有兩條黑色翼帶。適應力極強，廣泛分布於城市廣場與公園。"
    },
    "Streptopelia tranquebarica": { # 紅鳩
        ...
        "desc": "紅鳩（學名：Streptopelia tranquebarica），台灣最小型的鳩鴿科鳥類。雄鳥頭部鼠灰色，頸部有黑色頸環，背部為磚紅色，常見於電線或地面覓食。"
    },
    "Spilopelia chinensis": { # 珠頸斑鳩
        ...
        "desc": "珠頸斑鳩（學名：Spilopelia chinensis），特徵是後頸有布滿白點的黑色頸環，宛如珍珠項鍊。叫聲為低沉的「咕-咕-咕」，是城市中極為常見的鳥類。"
    },
    "Aythya fuligula": { # 鳳頭潛鴨
        ...
        "desc": "鳳頭潛鴨（學名：Aythya fuligula），又名澤鳧。雄鳥頭部有明顯的下垂冠羽，身體黑色，腹部白色。是台灣冬季常見的候鳥，常成群在湖泊或魚塭潛水覓食。"
    }
}
...
HOT_SPOTS_DATA = {
    "台北市": [
        ...
        {"name": "松山文創園區", "lat": 25.0438, "lng": 121.5606, "desc": "信義區的生態跳島，生態池雖小但生機盎然。是市區觀賞翠鳥捕魚、紅冠水雞築巢的熱門景點，偶爾也能發現鳳頭蒼鷹在此停棲。", "potential": [{"name":"翠鳥", "sci":"Alcedo atthis"}, {"name":"紅冠水雞", "sci":"Gallinula chloropus"}, {"name":"白腹秧雞", "sci":"Amaurornis phoenicurus"}]},
        {"name": "華江雁鴨自然公園", "lat": 25.0355, "lng": 121.4930, "desc": "位於新店溪與大漢溪匯流處，廣大的沙洲濕地是冬季候鳥的五星級飯店。每年10月至隔年3月，數以千計的小水鴨、琵嘴鴨在此度冬，場面壯觀。", "potential": [{"name":"小水鴨", "sci":"Anas crecca"}, {"name":"琵嘴鴨", "sci":"Spatula clypeata"}, {"name":"蒼鷺", "sci":"Ardea cinerea"}]},
        {"name": "台北植物園", "lat": 25.0315, "lng": 121.5090, "desc": "都市中難得的生態綠洲，因植被豐富且歷史悠久，吸引大量留鳥棲息。這裡是攝影愛好者拍攝翠鳥、五色鳥育雛的聖地，也是觀察黑冠麻鷺的最佳教室。", "potential": [{"name":"五色鳥", "sci":"Psilopogon nuchalis"}, {"name":"黑冠麻鷺", "sci":"Gorsachius melanolophus"}, {"name":"紅冠水雞", "sci":"Gallinula chloropus"}]},
        {"name": "大安森林公園", "lat": 25.0305, "lng": 121.5360, "desc": "市中心的綠色心臟，以穩定的鳳頭蒼鷹繁殖紀錄聞名。公園內的生態池常有白腹秧雞與紅冠水雞築巢，是市民最容易親近飛羽朋友的地方。", "potential": [{"name":"鳳頭蒼鷹", "sci":"Accipiter trivirgatus"}, {"name":"鵲鴝", "sci":"Copsychus saularis"}, {"name":"五色鳥", "sci":"Psilopogon nuchalis"}]},
        {"name": "關渡自然公園", "lat": 25.1175, "lng": 121.4720, "desc": "北台灣最重要的國際級濕地，位於淡水河與基隆河交會處。擁有豐富的紅樹林與泥灘地，是黑面琵鷺、各類水鳥遷徙的重要中繼站與度冬區。", "potential": [{"name":"黑面琵鷺", "sci":"Platalea minor"}, {"name":"小鷿鷈", "sci":"Tachybaptus ruficollis"}, {"name":"大白鷺", "sci":"Ardea alba"}]},
        ...
        {"name": "社子島濕地", "lat": 25.1110, "lng": 121.4590, "desc": "基隆河與淡水河交匯的半島尖端，擁有廣闊的泥灘地。退潮時會吸引大量鷸鴴科鳥類覓食，運氣好還能見到黑面琵鷺造訪。", "potential": [{"name":"反嘴鴴", "sci":"Recurvirostra avosetta"}, {"name":"高蹺鴴", "sci":"Himantopus himantopus"}, {"name":"中杓鷸", "sci":"Numenius phaeopus"}]}
    ],
    "新北市": [
        ...
        {"name": "金山清水濕地", "lat": 25.2320, "lng": 121.6330, "desc": "北海岸珍貴的水田濕地，因小白鶴曾在此長駐而聲名大噪。這裡是大型水鳥如東方白鸛、各類鷺科鳥類遷徙的重要補給站。", "potential": [{"name":"東方白鸛", "sci":"Ciconia boyciana"}, {"name":"小白鷺", "sci":"Egretta garzetta"}, {"name":"唐白鷺", "sci":"Egretta eulophotes"}]},
        {"name": "烏來福山部落", "lat": 24.7820, "lng": 121.5005, "desc": "深入南勢溪上游的低海拔闊葉林，溪流生態豐富。是觀察河烏、鉛色水鶇等溪澗鳥類，以及山區特有種畫眉的絕佳地點。", "potential": [{"name":"鉛色水鶇", "sci":"Phoenicurus fuliginosus"}, {"name":"河烏", "sci":"Cinclus pallasii"}, {"name":"紫嘯鶇", "sci":"Myophonus insularis"}]},
    ...
    "桃園市": [
        ...
        {"name": "大園水田區", "lat": 25.0590, "lng": 121.1960, "desc": "廣闊的休耕水田是水鳥最好的餐廳。這裡是觀察小辮鴴、雲雀鴴以及各種過境鷸鴴科鳥類的熱門區域，適合開車沿路搜尋。", "potential": [{"name":"小辮鴴", "sci":"Vanellus vanellus"}, {"name":"鷹斑鷸", "sci":"Tringa glareola"}, {"name":"雲雀鴴", "sci":"Glareola maldivarum"}]},
    ...
    "宜蘭縣": [
        {"name": "蘭陽溪口 (東港)", "lat": 24.7170, "lng": 121.8330, "desc": "宜蘭最重要的水鳥棲地，列名國家級重要濕地。廣闊的沙洲與潮間帶，每年吸引無數鷗科、鷸鴴科及雁鴨科候鳥在此度冬與過境。", "potential": [{"name":"小燕鷗", "sci":"Sternula albifrons"}, {"name":"翻石鷸", "sci":"Arenaria interpres"}, {"name":"黑尾鷸", "sci":"Limosa limosa"}]},
        {"name": "蘇澳無尾港水鳥保護區", "lat": 24.6025, "lng": 121.8505, "desc": "全台第一個水鳥保護區，湧泉與沼澤地形豐富。是花嘴鴨、小水鴨等雁鴨科鳥類的重要度冬地，冬季時水面鴨群密布。", "potential": [{"name":"花嘴鴨", "sci":"Anas zonorhyncha"}, {"name":"小水鴨", "sci":"Anas crecca"}, {"name":"魚鷹", "sci":"Pandion haliaetus"}]},
        {"name": "宜蘭五十二甲溼地", "lat": 24.6530, "lng": 121.8150, "desc": "擁有全台最大的穗花棋盤腳群落，夏季夜間盛開如煙火。廣闊的水田與沼澤環境，是水雉、灰雁及大量鷸鴴科候鳥的度冬熱點，生態極為豐富。", "potential": [{"name":"黑面琵鷺", "sci":"Platalea minor"}, {"name":"水雉", "sci":"Hydrophasianus chirurgus"}, {"name":"高蹺鴴", "sci":"Himantopus himantopus"}]},
    ...
    "金門縣": [
        {"name": "金門慈湖", "lat": 24.4620, "lng": 118.2805, "desc": "金門最大的鹹水湖，與廈門相望。冬季黃昏時分，數千隻鸕鶿呈人字形隊伍歸巢，黑壓壓一片覆蓋天空，是金門最著名的生態奇景。", "potential": [{"name":"鸕鶿", "sci":"Phalacrocorax carbo"}, {"name":"褐翅鴉鵑", "sci":"Centropus sinensis"}]},
        {"name": "金門金沙溪口", "lat": 24.4920, "lng": 118.4130, "desc": "淡水與海水交會的河口，生態多樣。這裡可觀察到懸停覓食的斑點魚狗（斑翡翠），以及蒼鷺靜立水中的身影。", "potential": [{"name":"斑點魚狗", "sci":"Ceryle rudis"}, {"name":"蒼鷺", "sci":"Ardea cinerea"}]},
...
def main():
    ...
    print(f"\n🎉 V12 更新完成！")
    print(f"   - 總資料筆數: {len(final_bird_list)}")
